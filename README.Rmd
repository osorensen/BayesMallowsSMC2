...
BayesMallowsSMC2 provides functions for performing sequential inference in the Bayesian Mallows model using the SMC$^{2}$ algorithm. The package implements the methods described in Sørensen, Frigessi, and Scheel (2025), "Sequential Rank and Preference Learning with the Bayesian Mallows Model", *Bayesian Analysis*.
...
Sørensen, Ø., Frigessi, A., & Scheel, I. (2025). Sequential Rank and Preference Learning with the Bayesian Mallows Model. *Bayesian Analysis*. https://doi.org/10.1214/25-BA1564
